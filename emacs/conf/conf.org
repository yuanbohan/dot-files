...
| C-c o           | occur                                    |
| M-o             | runs the command ace-window              |
| s-t             | treemacs                                 |
| C-c t           | libvterm                                 |
| s-p             | projectile                               |
| C-x w           | elfeed                                   |
  ...
  (use-package elfeed
    ...
    (setq elfeed-feeds
          '(("https://planet.emacslife.com/atom.xml" emacs)
            ("https://tdodge.consulting/blog/rss.xml" blog))))
#+end_src
