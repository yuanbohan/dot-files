...
[[https://www.tug.org/texlive/][texlive installation]] (~sudo apt install texlive-full~ is ok on Ubuntu 18.04)
[[https://www.latex-tutorial.com/][latex tutorials]]
[[https://www.emacswiki.org/emacs/AUCTeX][emacs wiki]]
[[https://tex.stackexchange.com/questions/339/latex-editors-ides][tex.stackexchange]]
[[https://tex.stackexchange.com/questions/20843/useful-shortcuts-or-key-bindings-or-predefined-commands-for-emacsauctex/21026#21026][key bindings]]

~C-c C-c~: to run LaTeX over your document, ~C-c C-c~ again to view it
~C-c C-a~: to run LaTeX and eventually opens the output document in the viewer. It is like running C-c C-c repeatedly, but with just a single key binding.
~C-c `~  : to see the errors.
~C-c C-v~: view document (without compiling)

~C-c C-s~: create section with optional label
~C-c C-e~: create environment (\begin and \end tags) choose from an autocomplete list or type your own
...
[[https://github.com/jwiegley/use-package/issues/379][use-package issue about auctex]]
#+BEGIN_SRC emacs-lisp
  (use-package latex
    :ensure auctex
    :config
